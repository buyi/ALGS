...
/*
 * Shellsort. Shellsort is a simple extension of insertion sort that gains speed
 * by allowing exchanges of entries that are far apart, to produce partially
 ...
 * hth entry (starting anywhere) yields a sorted sequence. Such an array is said
 * to be h-sorted.
 */
public class Shell {
